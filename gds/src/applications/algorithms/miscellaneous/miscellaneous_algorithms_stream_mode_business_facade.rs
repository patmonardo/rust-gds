...
use crate::applications::algorithms::machinery::{
    AlgorithmProcessingTemplateConvenience, StreamResultBuilder, AlgorithmLabel,
};
use crate::config::base_types::Config;

#[derive(Clone)]
pub struct MiscellaneousAlgorithmsStreamModeBusinessFacade {
...
impl MiscellaneousAlgorithmsStreamModeBusinessFacade {
    pub fn new(
        estimation_facade: MiscellaneousAlgorithmsEstimationModeBusinessFacade,
        miscellaneous_algorithms: MiscellaneousAlgorithms,
        algorithm_processing_template_convenience: AlgorithmProcessingTemplateConvenience,
    ...
    /// Scale Properties stream mode
    pub fn scale_properties<C: Config, RESULT>(
        &self,
        graph_name: GraphName,
        configuration: C,
        result_builder: impl StreamResultBuilder<ScalePropertiesResult, RESULT>,
    ) -> RESULT {
