...
//!
//! This macro generates type-safe, paged array implementations for all primitive types.
//! Each generated array automatically handles the single-page vs multi-page distinction
//! based on size, providing cursor support and memory-efficient storage.
