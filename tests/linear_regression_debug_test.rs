...
use rust_gds::ml::models::{Features, RegressorTrainer, Regressor, BaseModelData};
...
mod debug_tests {
    ...
    fn test_linear_regressor_direct() {
        ...
        println!("Direct prediction for x=1.0: {} (expected 3.0)", prediction_1);
        println!("Direct prediction for x=2.0: {} (expected 5.0)", prediction_2);
    ...
    fn test_linear_regression_debug() {
        ...
        println!("Training config: penalty={}, learning_rate={}, batch_size={}", 
                 train_config.penalty(), train_config.learning_rate(), train_config.batch_size());
        ...
        if let Some(linear_regressor) = regressor.as_any().downcast_ref::<LinearRegressor>() {
            ...
            println!("Model data feature dimension: {}", model_data.feature_dimension());
            ...
            println!("Regressor type: {:?}", std::any::type_name_of_val(&*regressor));
        }
    }
}
